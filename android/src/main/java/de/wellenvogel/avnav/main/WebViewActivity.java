...
public class WebViewActivity extends WebViewActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        String workaround="";
        //TODO: enable this on android < 4.4
        //workaround="&touchoverlay=1";
        webView.loadDataWithBaseURL(URLPREFIX+"viewer/dummy.html?navurl=avnav_navi.php"+workaround,htmlPage,"text/html","UTF-8",null);
